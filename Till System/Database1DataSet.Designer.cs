...
namespace Till_System {
    ...
    public partial class Database1DataSet : global::System.Data.DataSet {
        ...
        public partial class Table1DataTable : global::System.Data.TypedTableBase<Table1Row> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public Table1Row AddTable1Row(string Name, decimal Money) {
        ...
        public partial class Table1Row : global::System.Data.DataRow {
            ...
            public decimal Money {
                get {
                    try {
                        return ((decimal)(this[this.tableTable1.MoneyColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
...
namespace Till_System.Database1DataSetTableAdapters {
    ...
    public partial class Table1TableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM `Table1` WHERE ((`ID` = ?) AND ((? = 1 AND `Name` IS NULL) OR (`Name`" +
                " = ?)) AND ((? = 1 AND `Money` IS NULL) OR (`Money` = ?)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `Table1` (`Name`, `Money`) VALUES (?, ?)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE `Table1` SET `Name` = ?, `Money` = ? WHERE ((`ID` = ?) AND ((? = 1 AND `Na" +
                "me` IS NULL) OR (`Name` = ?)) AND ((? = 1 AND `Money` IS NULL) OR (`Money` = ?))" +
                ")";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, Name, [Money] FROM Table1";
        ...
        public virtual int Delete(int Original_ID, string Original_Name, global::System.Nullable<decimal> Original_Money) {
        ...
        public virtual int Insert(string Name, global::System.Nullable<decimal> Money) {
            if ((Name == null)) {
        ...
        public virtual int Update(string Name, global::System.Nullable<decimal> Money, int Original_ID, string Original_Name, global::System.Nullable<decimal> Original_Money) {
            if ((Name == null)) {
            ...
            if ((Original_Money.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[6].Value = ((decimal)(Original_Money.Value));
            }
            else {
